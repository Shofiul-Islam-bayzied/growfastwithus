...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      {/* Header */}
      <header ref={headerRef} className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${headerScrolled ? 'glass-card shadow-lg' : ''}`}>
            ...
            >
              <div className="p-6 space-y-1">
                ...
                >
                  <Button 
                    size="lg" 
                    className="w-full bg-primary hover:bg-primary/90 text-white font-semibold shadow-lg hover:shadow-primary/25 transition-all duration-200"
                    onClick={() => {
                  ...
                  <BookingButton 
                    size="lg"
                    className="w-full bg-gradient-to-r from-primary to-orange-600 hover:from-primary/90 hover:to-orange-600/90 text-white font-semibold shadow-lg hover:shadow-primary/25 transition-all duration-200"
                    calLink="grow-fast-with-us/30min"
                  >
                    Book Discovery Call
                  </BookingButton>
      ...
      {/* Hero Section */}
      <section id="home" ref={heroRef} className="min-h-screen bg-background relative overflow-hidden scroll-mt-24">
      ...
      {/* Services Overview */}
      <section id="services" ref={servicesRef} className="py-20 bg-background scroll-mt-24">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6">
            ...
            <Carousel className="max-w-6xl mx-auto">
              <CarouselContent className="px-2">
                {[
                  ...
                  <CarouselItem key={tech.name} className="basis-[20%] sm:basis-[20%] pl-2 snap-start">
                    <motion.div
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      ...
                      className="group"
                    >
                      <Card className="glass-card p-2 hover:border-primary/30 transition-all duration-300 h-24 flex items-center justify-center">
                        <CardContent className="p-0 text-center">
                          <div className="w-5 h-5 rounded-lg flex items-center justify-center mx-auto mb-1 group-hover:bg-primary/20 transition-colors">
                            <tech.icon className="w-3 h-3 text-gray-400 group-hover:text-primary transition-colors" />
                          </div>
                          <p className="text-[9px] font-medium text-gray-300 group-hover:text-white transition-colors">{tech.name}</p>
                        </CardContent>
                      </Card>
                    </motion.div>
                  </CarouselItem>
          ...
          {/* Desktop grid */}
          <div className="hidden md:grid grid-cols-4 lg:grid-cols-8 gap-6 max-w-6xl mx-auto">
            {[
              { name: "n8n", icon: SiN8N },
              { name: "Zapier", icon: SiZapier },
              { name: "Make", icon: SiMake },
      ...
      {/* Templates Showcase */}
      <section id="templates" ref={templatesRef} className="py-20 bg-background scroll-mt-24">
        <div className="container mx-auto px-6">
          <motion.div
            className="text-center mb-16"
            initial={{ opacity: 0, y: 30 }}
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              {categories.map((category) => (
                <Button
                  ...
                  className="rounded-full border border-[#ff6933]"
                >
                  {category}
                </Button>
              ))}
                    ...
                    <CardContent className="p-8 relative z-10">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Link href={`/template/${template.id}`}>
                          <Button variant="accentOutline" className="transition-all">
                            Learn More
                          </Button>
                        </Link>
                      </div>
      ...
      <section id="pricing" ref={pricingRef} className="py-20 bg-background scroll-mt-24">
        <div className="container mx-auto px-6">
          <motion.div
            className="text-center mb-16"
            initial={{ opacity: 0, y: 30 }}
              ...
              <CardContent className="p-0">
                <div className="flex flex-col md:flex-row gap-4">
                  <input
                    ...
                    className="flex-1 px-6 py-4 bg-black/30 border-2 border-gray-700 rounded-full text-white placeholder-gray-400 focus:border-primary focus:outline-none transition-all duration-300 text-lg"
                  />
                  <Button 
