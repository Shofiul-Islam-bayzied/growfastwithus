...
// Copied from pages/admin/dashboard.tsx to avoid Pages Router SSR issues
...
import { LogOut, Settings, Users, Upload, Star, Monitor, Code, Palette } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  if (!isAuthenticated) return null; // App router will redirect at route level
      ...
      <div className="bg-black/50 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <Button onClick={logout} variant="outline" className="bg-transparent border-white/20 text-white hover:bg-white/10">
